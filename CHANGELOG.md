...
## [0.3.0](https://github.com/pyyupsk/aipass-proxy/compare/aipass-proxy-v0.2.1...aipass-proxy-v0.3.0) (2026-09-19)
...
* add plugin tsconfig and install plugin deps in publish workflow ([5bd7cfa](https://github.com/pyyupsk/aipass-proxy/commit/5bd7cfa47b0bb2af1b4c2e66acdf3f4b9a90746d))
* add repository field for npm provenance verification ([fde1cfb](https://github.com/pyyupsk/aipass-proxy/commit/fde1cfbaa01f9fc9a8a0527ae08c1d86ad8499bf))
...
* build opencode-aipass to dist for npm publish ([8ff9393](https://github.com/pyyupsk/aipass-proxy/commit/8ff93934024f2c2603423380ec16f6b2aafb5608))
* correct working directory for plugin typecheck in publish workflow ([18f7eba](https://github.com/pyyupsk/aipass-proxy/commit/18f7eba48d52e20e5e20c4d62d0cdd644ea4e447))
...
* publish without provenance for trusted publisher retry ([2f9a6fb](https://github.com/pyyupsk/aipass-proxy/commit/2f9a6fbe750fe6e3ebb3148e3c043122a04dbbf9))
* restore NPM_TOKEN for publish with trusted publisher ([86a4284](https://github.com/pyyupsk/aipass-proxy/commit/86a42848d7bf7acb6cde9dc4898b953a653baa82))
...
* use correct SHA for setup-node in publish workflow ([84d5194](https://github.com/pyyupsk/aipass-proxy/commit/84d51943f7cdf97fd136ce9747ae13a51b0d67f2))
* use OIDC trusted publishing for opencode-aipass without NPM_TOKEN ([e2455ab](https://github.com/pyyupsk/aipass-proxy/commit/e2455abce0a67c92f1017e8878f098ee58260167))
